  ...
  void _showPopupNotification(BuildContext context, String actionName) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Tính năng "$actionName" cho mẫu móng này hiện đang được tích hợp hệ thống.',
        ),
        actions: [
          TextButton(
      ...
      body: Center(
        child: Container(
          constraints: const BoxConstraints(
            maxWidth: 402,
          ), // Đồng bộ kích thước khung dự án
          child: Stack(
            children: [
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(
                        ...
                        20,
                        100,
                      ), // Thừa khoảng trống đáy để không bị cụm nút che
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInfoRow(
                            'Shape',
                            nailData['shape'] ?? 'Standard',
                          ),
                          _buildInfoRow(
                            'Length',
                            nailData['length'] ?? 'Medium',
                          ),
                          _buildInfoRow(
                            'Surface',
                            nailData['surface'] ?? 'Glossy',
                          ),
                          _buildInfoRow(
                            'Decorate',
                            nailData['decorate'] ?? 'None',
                          ),
                          _buildInfoRow(
                            'Occasion',
                            nailData['occasion'] ?? 'General',
                          ),
                          _buildInfoRow(
                            'Color',
                            nailData['color'] ?? 'Multi-color',
                          ),
                          _buildInfoRow(
                            'Personality',
                            nailData['personality'] ?? 'Trendy',
                          ),
                        ],
                      ),
                    ),
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: OutlinedButton.icon(
                            onPressed: () => _showPopupNotification(
                              context,
                              'Virtual Try On',
                            ),
                            icon: const Icon(
