...
class S {
  ...
  String get clearFilter {
    return Intl.message('Clear filter', name: 'clearFilter', desc: '', args: []);
  }

  /// `Cannot load nail designs.`
  String get nailLoadError {
    return Intl.message('Cannot load nail designs.', name: 'nailLoadError', desc: '', args: []);
  }
  ...
  String get nailDesignFallback {
    return Intl.message('Nail design', name: 'nailDesignFallback', desc: '', args: []);
  }

  /// `Introduction`
  String get introduction {
    return Intl.message('Introduction', name: 'introduction', desc: '', args: []);
  }

  /// `Premium artistic nail designs...`
  String get nailDescriptionDefault {
    return Intl.message('Premium artistic nail designs meticulously crafted by top nail artists, bringing a glamorous, attractive, and personal look for women.', name: 'nailDescriptionDefault', desc: '', args: []);
  }

  /// `Available variants`
  String get availableVariants {
    return Intl.message('Available variants', name: 'availableVariants', desc: '', args: []);
  }

  /// `There are currently no variants available for this design.`
  String get noVariantsAvailable {
    return Intl.message('There are currently no variants available for this design.', name: 'noVariantsAvailable', desc: '', args: []);
  }
  ...
  String get nailSurfaceLabel {
    return Intl.message('Surface', name: 'nailSurfaceLabel', desc: '', args: []);
  }
  ...
  String get availableForTryOn {
    return Intl.message('Available for try-on', name: 'availableForTryOn', desc: '', args: []);
  }
  ...
  String get variantDetailsTitle {
    return Intl.message('Variant Details', name: 'variantDetailsTitle', desc: '', args: []);
  }
  ...
  String get designComponentsLabel {
    return Intl.message('Design components', name: 'designComponentsLabel', desc: '', args: []);
  }
  ...
  String get bookAppointmentNow {
    return Intl.message('Book now', name: 'bookAppointmentNow', desc: '', args: []);
  }

  /// `Form shaping method`
  String get shapeMethodLabel {
    return Intl.message('Form shaping method', name: 'shapeMethodLabel', desc: '', args: []);
  }

  /// `Decoration`
  String get decorationLabel {
    return Intl.message('Decoration', name: 'decorationLabel', desc: '', args: []);
  }
