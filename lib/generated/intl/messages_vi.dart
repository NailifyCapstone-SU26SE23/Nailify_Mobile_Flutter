...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(count) => "Áp dụng (${count})";

  static String m1(value) => "Giảm ${value} đ";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "bookServiceTitle": MessageLookupByLibrary.simpleMessage(
      "Đặt Lịch Dịch Vụ",
    ),
    "bookThisDesign": MessageLookupByLibrary.simpleMessage("Đặt lịch mẫu này"),
    "bookingAddService": MessageLookupByLibrary.simpleMessage("Thêm dịch vụ"),
    ...
    "bookingArtistTab": MessageLookupByLibrary.simpleMessage("Chọn thợ"),
    ...
    "bookingInfoOriginalPrice": MessageLookupByLibrary.simpleMessage("Giá gốc"),
    "bookingInfoService": MessageLookupByLibrary.simpleMessage("Dịch vụ"),
    ...
    "bookingNoApply": MessageLookupByLibrary.simpleMessage("Không áp dụng"),
    "bookingNoArtistAvailable": MessageLookupByLibrary.simpleMessage(
      "Không có thợ nào khả dụng cho ngày này.",
    ),
    "bookingNoArtistTab": MessageLookupByLibrary.simpleMessage(
      "Không chọn thợ",
    ),
    ...
    "bookingSummaryArtist": MessageLookupByLibrary.simpleMessage(
      "Thợ thực hiện",
    ),
    "bookingSummaryBranch": MessageLookupByLibrary.simpleMessage("Chi nhánh"),
    "bookingSummaryDate": MessageLookupByLibrary.simpleMessage("Ngày hẹn"),
    "bookingSummaryTime": MessageLookupByLibrary.simpleMessage("Thời gian"),
    "bookingTabReschedule": MessageLookupByLibrary.simpleMessage("Dời lịch"),
    ...
    "bookingValidateSalon": MessageLookupByLibrary.simpleMessage(
      "Vui lòng chọn một chi nhánh salon.",
    ),
    ...
    "cancelBookingReasonTooLong": MessageLookupByLibrary.simpleMessage(
      "Lý do không được vượt quá 50 từ",
    ),
    ...
    "exploreServices": MessageLookupByLibrary.simpleMessage("Khám phá dịch vụ"),
    ...
    "filterAll": MessageLookupByLibrary.simpleMessage("Tất cả"),
    ...
    "homeCtaTitle": MessageLookupByLibrary.simpleMessage("Đặt Lịch Hẹn Ngay!"),
    "homeQuizHeading": MessageLookupByLibrary.simpleMessage(
      "Tìm kiếm mẫu móng phù hợp nhất",
    ),
    ...
    "myComponents": MessageLookupByLibrary.simpleMessage("Phụ kiện của tôi"),
    ...
    "noAccessorySelected": MessageLookupByLibrary.simpleMessage(
      "Chưa chọn phụ kiện trên móng",
    ),
    "noComponents": MessageLookupByLibrary.simpleMessage(
    ...
    "noRequests": MessageLookupByLibrary.simpleMessage("Chưa có yêu cầu nào."),
    ...
    "ourPromiseHeading": MessageLookupByLibrary.simpleMessage(
    ...
    "ourPromiseTitle": MessageLookupByLibrary.simpleMessage("LỜI CAM KẾT"),
    ...
    "quizBannerDesign": MessageLookupByLibrary.simpleMessage(
      "Tự thiết kế móng",
    ),
    ...
    "quizBannerRetake": MessageLookupByLibrary.simpleMessage(
      "Làm lại trắc nghiệm",
    ),
    ...
    "rescheduleReason": MessageLookupByLibrary.simpleMessage("Lý do dời: "),
    ...
    "retryBtn": MessageLookupByLibrary.simpleMessage("Thử lại"),
    ...
    "reviewsTitle": MessageLookupByLibrary.simpleMessage("Ý KIẾN KHÁCH HÀNG"),
    "save": MessageLookupByLibrary.simpleMessage("Lưu"),
    "saveDesignButton": MessageLookupByLibrary.simpleMessage("Lưu thiết kế"),
    "saveDesignSuccess": MessageLookupByLibrary.simpleMessage(
      "Đã lưu thiết lập thử móng.",
    ),
    ...
    "selectNailShapeWarn": MessageLookupByLibrary.simpleMessage(
      "Vui lòng chọn dáng móng.",
    ),
    "selectNailTitle": MessageLookupByLibrary.simpleMessage(
      "Chọn mẫu móng thiết kế",
    ),
    "selectSalon": MessageLookupByLibrary.simpleMessage("Chọn tiệm"),
    ...
    "selectService": MessageLookupByLibrary.simpleMessage("Chọn Dịch Vụ"),
    "selectTime": MessageLookupByLibrary.simpleMessage("Chọn Giờ"),
    ...
    "statusCompleted": MessageLookupByLibrary.simpleMessage("Đã hoàn thành"),
    ...
    "statusReview": MessageLookupByLibrary.simpleMessage("Đang thẩm định"),
    "statusReviewed": MessageLookupByLibrary.simpleMessage("Thợ đã đánh giá"),
    "studioAllTab": MessageLookupByLibrary.simpleMessage("Tất cả"),
    "studioApprovedTab": MessageLookupByLibrary.simpleMessage("Đã duyệt"),
    "studioCreateNew": MessageLookupByLibrary.simpleMessage("Tạo mẫu mới"),
    "studioNoRequests": MessageLookupByLibrary.simpleMessage(
      "Chưa có yêu cầu duyệt nào.",
    ),
    "studioProcessingTab": MessageLookupByLibrary.simpleMessage("Đang xử lý"),
    "studioRejectedTab": MessageLookupByLibrary.simpleMessage("Từ chối"),
    "styleFitReasons": MessageLookupByLibrary.simpleMessage(
      "Lý do phù hợp với phong cách",
    ),
    ...
    "systemModels": MessageLookupByLibrary.simpleMessage("Mẫu hệ thống"),
    ...
    "tryOnTabAccessories": MessageLookupByLibrary.simpleMessage("Phụ kiện"),
    ...
    "waitlistStatusPending": MessageLookupByLibrary.simpleMessage(
      "ĐANG XẼP HÀNG",
    ),
    "warrantyButton": MessageLookupByLibrary.simpleMessage("Bảo hành"),
    "warrantyPrefix": MessageLookupByLibrary.simpleMessage("Bảo hành"),
    ...
    "nailLoadError": MessageLookupByLibrary.simpleMessage("Không thể tải danh sách móng."),
    "recommended": MessageLookupByLibrary.simpleMessage("Được đề xuất"),
    "nailDesignFallback": MessageLookupByLibrary.simpleMessage("Mẫu thiết kế móng"),
    "introduction": MessageLookupByLibrary.simpleMessage("Giới thiệu"),
    "nailDescriptionDefault": MessageLookupByLibrary.simpleMessage("Mẫu thiết kế nghệ thuật cao cấp được chăm chút tỉ mỉ từ các chuyên viên làm móng hàng đầu, mang lại vẻ ngoài kiêu sa, cuốn hút và cá tính cho phái nữ."),
    "availableVariants": MessageLookupByLibrary.simpleMessage("Phiên bản khả dụng"),
    "noVariantsAvailable": MessageLookupByLibrary.simpleMessage("Hiện chưa có phiên bản nào cho thiết kế này."),
    ...
    "availableForTryOn": MessageLookupByLibrary.simpleMessage("Khả dụng để trải nghiệm"),
    "loadDataError": (error) => "Lỗi khi tải dữ liệu: ${error}",
    "variantDetailsTitle": MessageLookupByLibrary.simpleMessage("Chi tiết phiên bản"),
    ...
    "designComponentsLabel": MessageLookupByLibrary.simpleMessage("Thành phần thiết kế"),
    ...
    "shapeMethodLabel": MessageLookupByLibrary.simpleMessage("Phương pháp tạo form"),
