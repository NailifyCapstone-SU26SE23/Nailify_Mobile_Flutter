...
class _ServiceDetailPageState extends State<ServiceDetailPage> {
    ...
    showDialog(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          title: const Text('Xác nhận đặt lịch', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
          content: Text(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: const Text('Đặt lịch ngay', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            )
          ],
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    final description = _serviceData!['description']?.toString().trim() ?? 'Không có mô tả.';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Chi tiết dịch vụ', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
        centerTitle: true,
        backgroundColor: Colors.white,
        elevation: 0,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(name, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.textPrimary), textAlign: TextAlign.center),
                  const SizedBox(height: 16),
                  Row(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(DurationFormatter.format(duration), style: const TextStyle(color: Colors.orange, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
            ...
            // Mô tả và Chi phí
            const Text('Mô tả dịch vụ', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 12),
            Text(description, style: const TextStyle(fontSize: 15, color: Colors.grey, height: 1.5)),
            const SizedBox(height: 24),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  const Text('Chi phí dịch vụ:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  Text(PriceFormatter.format(price), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: AppColors.primary)),
                ],
              ),
            ),
          ],
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton.icon(
          ...
          label: const Text('Đặt lịch dịch vụ này', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
        ),
      ),
    );
  }
