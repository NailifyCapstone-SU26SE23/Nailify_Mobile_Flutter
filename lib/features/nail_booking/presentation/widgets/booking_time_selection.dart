...
class BookingTimeSelection extends StatelessWidget {
  ...
  final DateTime?
  selectedDate; // BỔ SUNG: Nhận vào ngày đang chọn từ trang tổng
        ...
        if (!canSelect)
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final String time =
                  slot['startTime']; // Định dạng từ API: "09:30:00"
              ...
              if (isAvail && selectedDate != null) {
                ...
                if (isToday) {
                  ...
                  if (slotHour < now.hour ||
                    ...
                    isAvail =
                        false; // Ép trạng thái khả dụng về false để làm mờ ô này đi
                  }
                }
              }
              // ==========================================
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: isSelected
                          ? Colors.white
                          : (isAvail ? Colors.black : Colors.grey.shade400),
                      decoration: isAvail
                          ? null
                          : TextDecoration
                                .lineThrough, // Gạch ngang nếu là giờ quá khứ/bận
                    ),
                  ),
                ),
              );
